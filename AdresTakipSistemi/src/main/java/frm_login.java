...
public class frm_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, 127, -1));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel2.setText("Password   :");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, 109, 35));
        jPanel2.add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 135, 32));
        jPanel2.add(jp_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 160, 135, 34));
        ...
        jPanel2.add(btn_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, 150, 50));
        ...
        jPanel2.add(btn_register, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 250, 140, 50));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel3.setText("SHAMIL TEHNOLOGY");
        ...
        jPanel2.add(chkbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 170, 120, -1));
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        boolean ok=DataManage.LoginUser(userNAme, Passw);
        ...
        if(ok){
            ...
            JOptionPane.showMessageDialog(rootPane," Wrong username or password !","Login",JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        DataManage test1=new DataManage();
        test1.LoadTestDatas();
